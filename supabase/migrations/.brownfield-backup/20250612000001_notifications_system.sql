...
-- Legacy PrivyChat may already define notification_type with a subset of labels.
...
ALTER TYPE notification_type ADD VALUE IF NOT EXISTS 'new_like';
ALTER TYPE notification_type ADD VALUE IF NOT EXISTS 'new_payout';
...
DO $notification_preferences_brownfield$
BEGIN
  IF NOT EXISTS (
  ...
  ALTER TABLE public.notification_preferences ADD COLUMN IF NOT EXISTS preferences JSONB NOT NULL DEFAULT '{}';
  ...
  END IF;
END $notification_preferences_brownfield$;
