...
ALTER TYPE plan_billing_interval ADD VALUE IF NOT EXISTS 'monthly';
ALTER TYPE plan_billing_interval ADD VALUE IF NOT EXISTS 'annual';
ALTER TYPE plan_billing_interval ADD VALUE IF NOT EXISTS 'free';
