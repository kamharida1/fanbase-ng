...
SELECT public.fanbase_add_column_if_missing('reports', 'status', 'report_status DEFAULT ''open''');
SELECT public.fanbase_add_column_if_missing('reports', 'message_id', 'UUID');
SELECT public.fanbase_add_column_if_missing('reports', 'updated_at', 'TIMESTAMPTZ DEFAULT now()');
...
SELECT public.fanbase_add_column_if_missing('moderation_queue', 'status', 'moderation_status DEFAULT ''pending''');
SELECT public.fanbase_add_column_if_missing('moderation_queue', 'priority_score', 'INT DEFAULT 0');
SELECT public.fanbase_add_column_if_missing('moderation_queue', 'flags', 'JSONB DEFAULT ''{}''');
SELECT public.fanbase_add_column_if_missing('moderation_queue', 'updated_at', 'TIMESTAMPTZ DEFAULT now()');
